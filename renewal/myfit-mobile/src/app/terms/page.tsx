    ...
    <main style={{ flex: 1, display: 'flex', flexDirection: 'column', background: 'var(--myfit-bg)', minHeight: '100dvh', color: 'var(--myfit-text)' }}>
      ...
      <div className="scroll-area" style={{ flex: 1, padding: '8px 20px calc(24px + var(--safe-bottom))', display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        <Article title="제1조 (목적)">
          <P>본 약관은 G2 Company Ltd.(이하 &quot;회사&quot;)가 제공하는 MyFit 핏 예측 서비스(이하 &quot;서비스&quot;)의 이용 조건 및 절차, 이용자와 회사의 권리·의무 및 책임에 관한 사항을 규정합니다.</P>
        </Article>

        <Article title="제2조 (서비스 내용)">
          <P>회사는 다음 서비스를 제공합니다.</P>
          <List items={[
            '신체 치수와 의류 실측 사이즈를 대조한 부위별 핏 예측 및 사이즈 추천',
            '핏 예측 결과 저장 및 히스토리 관리(이 기기 내 저장)',
        ...
        <Article title="제3조 (사진·치수 데이터 이용)">
          <Callout>
            신체 치수·핏 기록·신체 사진은 이 기기(브라우저)에만 저장되며 회사 서버로 전송·보관하지 않습니다. 신체 사진은 저장 후 7일이 지나면 자동 삭제됩니다. 회사는 이용자의 사진을 별도로 저장하거나 마케팅 목적으로 사용하지 않습니다.
          </Callout>
          <List items={[
        ...
        <Article title="제6조 (핏 예측 결과 고지)">
          <Callout>
            핏 예측 결과는 이용자가 입력한 신체 치수와 의류 실측 사이즈를 대조해 계산한 참고용 결과물입니다. 실제 착용감, 원단 신축성, 사이즈와 차이가 있을 수 있으며, 회사는 결과의 정확성을 보장하지 않습니다.
          </Callout>
        </Article>
        ...
        <Article title="제8조 (면책 조항)">
          <List items={[
            '핏 예측 결과는 참고용이며, 실제 착용감과 차이가 있을 수 있습니다.',
