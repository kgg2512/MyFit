        ...
        >
          ...
          >
            ...
            {(DEMO_MODE ? [
              ...
              { label: '[안내] 현재 데모(시연) 버전입니다', desc: '샘플 데이터로 핏 예측을 체험하는 데모 버전입니다. 입력하신 치수·사진은 서버로 전송·저장되지 않으며, 이 기기에서만 사용됩니다.' },
              { label: '[필수] 제휴 마케팅 링크 고지 동의', desc: '쿠팡파트너스 활동의 일환으로 구매 시 수수료를 받을 수 있습니다.' },
            ] : [
              { label: '[필수] 개인정보 처리방침 동의', desc: '신체 치수와 신체 사진은 이 기기에만 저장되며, 회사 서버로 전송되지 않습니다. 신체 사진은 저장 후 7일이 지나면 자동 삭제됩니다.' },
              { label: '[필수] 제휴 마케팅 링크 고지 동의', desc: '쿠팡파트너스 활동의 일환으로 구매 시 수수료를 받을 수 있습니다.' },
            ]).map(item => (
