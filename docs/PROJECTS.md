...
## 신데렐라 (활성 프로젝트 #2)
**유형:** P2P 명품 렌탈 앱 (당근마켓 구조)  
**파일:** `cinderella_prototype.html`  
**상태:** 프로토타입 완성 — MVP 개발 범위 미확정  

### 핵심 컨셉
- 명품 보유자 ↔ 렌탈 희망자 P2P 직거래
- 당근마켓 구조: 지역 기반, 직접 인수인계
- 신뢰 시스템: 진품 보증, 사용자 후기, 보증금/에스크로

### 완료 항목
- [x] cinderella_prototype.html 완성
- [x] DESIGN.md 브랜드 시스템 초안

### 진행 예정
- [ ] 사용자 테스트 및 피드백 수집
- [ ] MVP 기능 범위 확정 (CTO + COO)
- [ ] 수익 모델 수치화 (CFO)
- [ ] 이용약관 및 분쟁 해결 조항 (CLO)
- [ ] P2P 거래 보안 구조 설계 (CISO)
